...
@section('title', 'Ubah Password Pembina')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-key"></i> Ubah Password Pembina</h1>
    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-user"></i> {{ $pembina->nama_lengkap }}
                </div>
                <div class="card-body">
                    <p class="mb-2"><strong>Email:</strong> {{ $pembina->user->email }}</p>
                    <div class="mb-3">
                        <small class="text-muted d-block">Password Saat Ini:</small>
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control" id="current-password" value="{{ $pembina->user->plain_password ?? '••••••••' }}" readonly>
                    ...
                    <form action="{{ route('pembina.update-password', $pembina) }}" method="POST">
                        @csrf
                        @method('PUT')
